...
function recover(){
	...
	colorecho -blue "------All Work Directory------"
	colorecho -red "git checkout ."
	colorecho -red "git clean -df"
	echo "tips: 1. git checkout . can remove all changes in work directory without files untracked"
	echo "      2. git clean -df can remove all files untracked without files in .gitignore"
	echo "      3. git clean -xdf canf remove all files untracked with files in .gitignore"
